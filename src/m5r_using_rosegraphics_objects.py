...
#                __repr__ clone get_bounding_box
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center, radius and tkinter.Canvas.create_oval
#
...
#            It is necessary when the user wants to close the window with everything is done as to remind the user how to exit the window.
#
